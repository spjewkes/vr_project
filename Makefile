...
_DEPS=collide.hpp defs.hpp error.hpp graphics.hpp instance.hpp master.hpp mouse.hpp options.hpp palette.hpp parse.hpp pfuncs.hpp program.hpp screen.hpp setup.hpp sound.hpp vector3d.hpp viewer.hpp world.hpp
